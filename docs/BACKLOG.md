...
- [x] 26개 이미지 자체 호스팅 이관 완료 (2026-08-10, docs/15 M3 — `FE/public/fish/` 정적 자산 + V22).
  실제 배포 crop 시각 QA는 R8 운영 QA에서 계속
...
- [x] M2 — 제철 캘린더 `/calendar/:month` 딥링크 + prerender/sitemap (SEO 랜딩 12개, 2026-08-10)
- [x] M3 — 26종 이미지 자체 호스팅 이관 + V22 (4.5 항목 승계, 2026-08-10)
